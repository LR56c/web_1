<div class="h-screen w-screen flex flex-col justify-between">
  <div>
    ...
    <div
      ...
      <div class="flex flex-col basis-2/3 gap-4">
        <div class="block md:hidden w-full flex justify-center">
          <img
        ...
        <div
          class="hidden md:flex lg:flex-nowrap flex-wrap lg:justify-start justify-center gap-4 lg:h-40 overflow-x-auto gap-4">
          <img class="h-36 h-36 rounded-lg"
               src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-1.jpg"
               alt=""/>
          <img class="h-36 h-36 rounded-lg"
  ...
  <div class=" my-4 md:my-8 flex w-full space-x-4">
    ...
    <p
      class="text-center text-xs text-gray-500 line-clamp-3 dark:text-gray-400 md:text-sm lg:text-base">Track
      work across
      the
  ...
  <div
    class="flex flex-wrap w-full gap-4 justify-center items-center bg-gray-100">
