  <div class="h-screen w-screen flex flex-col justify-between">
    <div class="flex flex-col">
      ...
      <div
        ...
        Estado de orden&nbsp;<p class="font-medium">#123456</p>
      </div>
      <div class="h-full w-full flex flex-col justify-center items-center">
        <ol
          class="flex mt-12  items-center mx-auto w-full sm:w-2/3 lg:w-1/2">
          <div class="basis-2/12"></div>
          <li
            class="flex w-full items-center text-blue-600 after:content-[''] after:w-full after:h-1 after:border-b after:border-blue-300 after:border-4 after:inline-block dark:after:border-blue-800">
            <span
          ...
          <li
            class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-300 after:border-4 after:inline-block dark:after:border-gray-700">
            <span
              class="flex items-center justify-center w-10 h-10 bg-gray-300 rounded-full lg:h-12 lg:w-12 dark:bg-gray-700 shrink-0">
                <svg aria-hidden="true"
                     class="w-5 h-5 text-gray-500 lg:w-6 lg:h-6 dark:text-gray-300"
                     fill="currentColor" viewBox="0 0 20 20"
                     xmlns="http://www.w3.org/2000/svg"><path
                  fill-rule="evenodd"
        ...
        <div class="flex justify-center items-center w-full h-64">
          <div
            class="flex flex-col gap-4 max-w-sm p-6 bg-white border border-gray-300 rounded-lg shadow">
            <h5
            ...
            <p class="font-normal text-gray-500 dark:text-gray-400">
              ...
              <a href="https://centrodeayuda.chilexpress.cl/seguimiento/87897569876"
