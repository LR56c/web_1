    ...
    <div class="mx-auto w-full container p-4 sm:p-6">
        <div class="md:flex md:justify-between">
            <div class="flex md:basis-1/2 flex-col items-center mb-6 md:mb-0">
                <a href="/src/pages/index.html" class="flex items-center hover:text-black">
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="/src/pages/404.html"
                               class="hover:underline hover:text-black">politica devolucion</a>
                        </li>
                        <li class="mb-4">
                            <a href="/src/pages/404.html"
                               class="hover:underline hover:text-black">politica privacidad</a>
                        </li>
                        <li class="mb-4">
                            <a href="/src/pages/404.html"
                               class="hover:underline hover:text-black">preguntas frecuentes</a>
                        </li>
                        <li>
                            <a href="/src/pages/404.html"
                               class="hover:underline hover:text-black">terminos y condiciones</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="/src/pages/404.html"
                               class="hover:text-black hover:underline">formulario de contacto</a>
                        </li>
                        <li>
                            <a href="/src/pages/404.html"
                               class="hover:text-black hover:underline">reclamos / sugerencias</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="/src/pages/404.html" class="hover:text-black hover:underline">+569
                                12345678</a>
                        </li>
                        <li class="mb-4">
                            <a href="/src/pages/404.html"
                               class="hover:text-black hover:underline">correo@correo.com</a>
                        </li>
                        <li>
                            <a href="/src/pages/404.html"
                               class="hover:text-black hover:underline">direccion 12. region.
                                chile</a>
                        </li>
                        <li>
                            <a href="/src/pages/404.html"
                               class="hover:text-black hover:underline">horario de atencion</a>
                        </li>
                    </ul>
                </div>
            </div>
