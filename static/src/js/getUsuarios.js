      ...
      .then( ( result ) => {
        if ( result.isConfirmed ) {
          ...
          const peticion = $.ajax( {
            async      : true,
            crossDomain: true,
            // url        : 'http://ec2-18-231-153-185.sa-east-1.compute.amazonaws.com:8000/administracion/usuarios/eliminar/' + idSelected,
            url        : 'http://127.0.0.1:8000/administracion/usuarios/eliminar/' +
              idSelected,
            method     : 'POST',
            data       : formData,
            processData: false,
