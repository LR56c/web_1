    ...
    <div
      ...
      <div class="space-y-6">
        ...
        <div class="flex items-start">
          <button
            data-modal-target="lost-modal"
            data-modal-toggle="lost-modal"
        ...
        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
          No estas registrado? <a href="/register"
                                  class="text-blue-700 hover:underline dark:text-blue-500">Crear
          cuenta</a>
        </div>
      </div>
    </div>
    <div aria-hidden="true" id="lost-modal"
      ...
      <div class="relative w-full h-full max-w-md md:h-auto">
        <div
          ...
          <div class="px-6 py-6 lg:px-8">
            <h3
              class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Reinicio de contraseña</h3>
            <div class="space-y-6">
              <div>
                <label for="email2"
